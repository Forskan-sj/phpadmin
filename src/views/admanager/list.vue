<template>
  <div class="app-container">
    <div class="addSchoolType">
      <router-link :to="'/admanager/options/'+'0'">
    ...
    >
      ...
      <el-table-column :label="'广告名称'" prop="id" sortable="custom" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="'操作'" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <router-link :to="'/admanager/options/'+scope.row.id">
            <el-button type="primary" size="small" icon="el-icon-edit">编辑</el-button>
          </router-link>
          <el-button type="danger" size="small" icon="el-icon-delete" @click="delt(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <pagination
  ...
  methods: {
    ...
    getList(index) {
      ...
      getLists(this.path, this.listQuery).then(response => {
        ...
        //   a.status = a.status === 1 ? true : false
        // })
        this.listLoading = false
      })
    }
