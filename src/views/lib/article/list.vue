<template>
  <div class="app-container">
    ...
    <div class="addSchoolType">
      <router-link :to="'/lib/article_edit/options/'+'0'">
    ...
    >
      ...
      <el-table-column :label="'文章作者'" prop="id" sortable="custom" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="'文章分类'" prop="id" sortable="custom" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="'操作'" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <router-link :to="'/lib/article_edit/options/'+scope.row.id">
